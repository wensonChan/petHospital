 ...
 */
@TableName("jiyang")
public class JiyangEntity<T> implements Serializable {
	 ...
	 * 设置：兽龄
	 */
	public void setShouling(String shouling) {
		this.shouling = shouling;
	}
	/**
	 * 获取：兽龄
	 */
	public String getShouling() {
		return shouling;
	}
	/**
	 * 设置：宠物详情
