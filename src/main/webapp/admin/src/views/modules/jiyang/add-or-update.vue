<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="兽龄" prop="shouling">
          <el-input v-model="ruleForm.shouling" 
              placeholder="兽龄" clearable  :readonly="ro.shouling"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="兽龄" prop="shouling">
              <el-input v-model="ruleForm.shouling" 
                placeholder="兽龄" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chongwumingcheng = true;
          ...
          if(o=='shouling'){
            this.ruleForm.shouling = obj[o];
	    this.ro.shouling = true;
            continue;
          }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiyang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiyangCrossAddOrUpdateFlag = false;
                  this.parent.search();
