    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="医生简介" prop="yishengjianjie">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yishengjianjie" label="医生简介" prop="yishengjianjie">
                    <span v-html="ruleForm.yishengjianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.yishengjianjie = this.ruleForm.yishengjianjie.replace(reg,'../../../petHospital/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
