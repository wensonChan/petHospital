<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="宠物编号" prop="chongwubianhao">
            <el-input v-model="ruleForm.chongwubianhao" 
                placeholder="宠物编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chongwubianhao" label="宠物编号" prop="chongwubianhao">
              <el-input v-model="ruleForm.chongwubianhao" 
                placeholder="宠物编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="品种" prop="pinzhong">
          <el-input v-model="ruleForm.pinzhong" 
              placeholder="品种" clearable  :readonly="ro.pinzhong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="品种" prop="pinzhong">
              <el-input v-model="ruleForm.pinzhong" 
                placeholder="品种" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="宠物详情" prop="chongwuxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.chongwuxiangqing" label="宠物详情" prop="chongwuxiangqing">
                    <span v-html="ruleForm.chongwuxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.chongwuxiangqing = this.ruleForm.chongwuxiangqing.replace(reg,'../../../petHospital/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
